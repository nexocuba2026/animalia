      ...
      {usuarios.length === 0 ? (
        ...
        <div className="space-y-4">
          {usuarios.map((usuario) => (
            <div key={usuario.id} className="bg-white border border-gray-200 rounded-2xl p-6">
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center font-bold text-sm uppercase">
                    ...
                    <div className="mt-3">
                      ...
                      <ul className="list-disc list-inside text-sm text-gray-500">
                        {usuario.mascotas.map((m) => (
                          <li key={m.id}>{m.nombre} (HC: {m.numero_historia_clinica})</li>
                        ))}
                      </ul>
                    </div>
                  )}
